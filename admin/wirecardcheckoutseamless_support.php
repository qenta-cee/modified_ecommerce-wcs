...
if (isset($_POST['send']) && is_array($_POST['support'])) {
    try {
        ...
        $msg .= base64_decode($wcsAdmin->getPluginVersion());
        $msg .= "<br/><br/>\n";

        $msg .= "Plugin configuration:<br/>\n";
        $msg .= $wcsAdmin->getConfigString();
        $msg .= "<br/><br/>\n";
...
if (isset($_GET['success'])) {
    $infos[] = $wcsAdmin->getText('SUPPORT_SUCCESS');
}
    ...
    <table class="tableBody">
        <tr>
            ...
            <td class="boxCenter">
                ...
                <div class="flt-l">
                    <div
                        class="pageHeading pdg2"><?php echo $wcsAdmin->getText('SUPPORT_HEADING_TITLE'); ?>
                    </div>
                </div>
                <?php
                ...
                <div class="clear div_box mrg5" style="margin-top:-1px;">
                    ...
                    <table class="clear tableConfig">
                        <tr>
                            <td class="dataTableConfig col-left"><?php echo $wcsAdmin->getText('SUPPORT_CHANNEL');
                        ...
                        <tr>
                            <td class="dataTableConfig col-left"><?php echo $wcsAdmin->getText('SUPPORT_REPLYTO');
                                echo '<br/>' . TEXT_FIELD_REQUIRED; ?></td>
                        ...
                        <tr>
                            <td class="dataTableConfig col-left"><?php echo $wcsAdmin->getText('SUPPORT_MESSAGE'); ?></td>
                            <td class="dataTableConfig col-middle">
                                <?php
                        ...
                        <tr>
                            <td class="txta-l" colspan="3" style="border:none;">
                                <input class="button btn_wide" type="submit" name="send"
                                       value="<?php echo $wcsAdmin->getText('SUPPORT_SEND'); ?>">
                            </td>
                        </tr>
                    </table>
                </div>
