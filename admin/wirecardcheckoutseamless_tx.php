...
//display per page
$cfg_max_display_results_key = 'MAX_DISPLAY_WCS_PAYMENTS_RESULTS';
...
if (in_array($action, array('edit', 'payment', 'credit')) && $txId > 0) {
    $transaction = $wcsTransaction->get($txId);
    if ($transaction !== null) {
        $edit = true;
    }
}
    ...
    <table class="tableBody">
        <tr>
            ...
            <td class="boxCenter">
                ...
                <div class="flt-l">
                    <div class="pageHeading pdg2"><?php echo $wcsBackend->getText('BACKEND_HEADING_TITLE') ?></div>
                </div>
                <?php
                ...
                <div class="clear div_box mrg5" style="margin-top:-1px;">
                    <?php
                    if ($edit) {
                        include(DIR_FS_EXTERNAL . 'wirecardcheckoutseamless/includes/tx_edit.php');
                    } else {
                        include(DIR_FS_EXTERNAL . 'wirecardcheckoutseamless/includes/tx_list.php');
                    }
                    ?>
                </div>
            </td>
