...
require_once(DIR_FS_CATALOG . 'includes/modules/payment/wcs_ccard.php');

class wcs_ccardmoto extends wcs_ccard
{
    ...
    protected $_iframeBuildFunc = 'buildIframeCreditCardMoto';
    ...
    protected function _configuration()
    {
        ...
        $config['USERGROUP'] = array(
            ...
            'use_function' => 'wcs_ccardmoto_cfg_get_groupname',
            'set_function' => "wcs_ccardmoto_cfg_pull_down_usergroups( "
        );
 ...
 * @return string
 */
function wcs_ccardmoto_cfg_pull_down_usergroups($provider, $key = '')
{
 ...
 * @return mixed
 */
function wcs_ccardmoto_cfg_get_groupname($group_id)
{
