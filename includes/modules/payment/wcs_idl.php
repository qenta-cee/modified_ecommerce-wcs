...
class wcs_idl extends WirecardCheckoutSeamlessPayment
{
    ...
    function selection()
    {
        ...
        $field = '<select class="wcs_idl input-select mandatory" data-wcs-fieldname="fi" name="wcs_ideal_financialinstitution">';
    ...
    {
        if (isset($_POST['wcs_ideal_financialinstitution'])) {
            $_SESSION['wcs_financialinstitution'] = $_POST['wcs_ideal_financialinstitution'];
        }
    }
}
