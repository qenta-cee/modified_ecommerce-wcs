...
class wcs_voucher extends WirecardCheckoutSeamlessPayment
{
    ...
    public function selection()
    {
        ...
        $content['fields'][] = array(
            'title' => $this->_seamless->getText('voucher_id'),
            'field' => sprintf('<input type="text" class="%s input-text" name="wcs_voucher" data-wcs-fieldname="voucherId" autocomplete="off" value=""/>',
                $cssClass)
        );
