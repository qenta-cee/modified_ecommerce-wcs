...
require_once(DIR_FS_CATALOG . 'includes/modules/payment/wcs_invoice.php');


class wcs_invoiceb2b extends wcs_invoice
{
    ...
    function _preCheck()
    {
        ...
        if (ACCOUNT_COMPANY != 'true') {
            $this->_seamless->log(__METHOD__ . ':Customer company fields not enabled.');
            return false;
        }
