...
$lang_array = array(
    'WIRECARDINFO' => '    <a href="https://www.wirecard.at/" target="_blank" title="www.wirecard.at"><img
                class="wirecardcheckoutseamless-logo" src="%s" alt="Wirecard"
                border="0"/>
    </a><br/>
    ...
    'CONFIG_HEADING_TITLE' => 'Wirecard Checkout Seamless Configuration',
    'BACKEND_HEADING_TITLE' => 'Wirecard Checkout Seamless Back-end',
    'TRANSFER_HEADING_TITLE' => 'Wirecard Checkout Seamless Fund transfer',
    'SUPPORT_HEADING_TITLE' => 'Wirecard Checkout Seamless Support request',
    'CONFIGURE' => 'Wirecard Checkout Seamless Configuration',
    'CONFIGURATION_HELP' => "Note that settings are made for each payment method. " .
        "For global payment settings, back-end operations and Wirecard support request click below. ",
    'ACTIVE' => 'Active',
    ...
    'MIN_AGE_MESSAGE' => "You have to be 18 years or older to use this payment.",
    ...
    'TABLE_HEADING_PAYMENTMETHOD' => 'Payment type',
    'TABLE_HEADING_PAYMENTSTATE' => 'Payment state',
    ...
    'AMOUNT' => 'Amount',
    'CURRENCY' => 'Currency',
    'FUNDTRANSFER_TYPE' => 'Fund transfer type',
    ...
    'ORDER_STATUS_CANCEL' => 'Status canceled payment',
...
foreach ($lang_array as $key => $val) {
    $key = 'TEXT_WIRECARDCHECKOUTSEAMLESS_' . $key;
