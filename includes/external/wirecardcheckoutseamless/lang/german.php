...
$lang_array = array(
    ...
    <p class="wirecardcheckoutseamless-intro">Wirecard - Ihr Full-Service Payment-Provider - Umfangreiche L&ouml;sungen aus einer Hand</p>
...
,
    ...
    'PCI3_DSS_SAQ_A_ENABLE_DESC' => 'Falls "Nein" gesetzt ist, gilt der strengere SAQ A-EP. Falls "Ja" gesetzt ist, wird in Wirecard Checkout Seamless das "PCI DSS SAQ A Compliance"-Feature verwendet und es gilt der SAQ A.',
